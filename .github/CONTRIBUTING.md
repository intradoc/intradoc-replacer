...
## 🛠️ Fixing Issues
 ...
 - [**Fork**][url-help-fork] **the project**, then:
   ...
   - **Clone your own fork**:
     ...
     ```bash
     git clone https://github.com/<your-username>/intradoc-templates.git
     ```

   - Navigate into the project's directory, **configure the remote**, then **install the dependencies**:

     ```bash
     git remote add upstream https://github.com/zengulp/intradoc-templates.git
     npm install
     ```     
...
<p align="center">
  ...
  <!--- URLs -->
  [url-commits]:       https://github.com/zengulp/intradoc-templates/commits
  [url-issues]:        https://github.com/zengulp/intradoc-templates/issues
  [url-new-issue]:     https://github.com/zengulp/intradoc-templates/issues/new/choose
  [url-coc]:           https://github.com/zengulp/intradoc-templates/blob/master/.github/CODE_OF_CONDUCT.md
  ...
  [url-ci]:        https://github.com/zengulp/intradoc-templates/actions?query=workflow%3Aci

  [url-license-isc]:   https://github.com/zengulp/intradoc-templates/blob/master/LICENSE.md
  ...
  [url-bugs]:            https://github.com/zengulp/intradoc-templates/issues
